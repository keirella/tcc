...
const styles = `
  ...
  .menu-card {
    ...
    border-radius: 18px;
    overflow: hidden;
    box-shadow: 0 2px 14px rgba(10,51,35,0.07);
  ...
  .menu-card:hover {
    ...
    box-shadow: 0 8px 28px rgba(10,51,35,0.12);
  }
  ...
  .modal {
    ...
    width: 460px;
    max-width: 95vw;
    box-shadow: 0 20px 60px rgba(10,51,35,0.2);
  }
...
const EMOJIS = { "Nasi Rendang": "🍛", "Ayam Gulai": "🍲", "Ayam Geprek Level 1": "🌶️", "Ayam Geprek Level 5": "🔥" };
...
export default function Menu() {
  ...
  const handleSave = () => {
    ...
    if (editing) {
      setMenus((prev) =>
        prev.map((m) =>
          m.id === editing ? { ...m, ...form, harga: +form.harga, stok: +form.stok } : m
        )
      );
    } else {
      setMenus((prev) => [
        ...prev,
        { id: Date.now(), ...form, harga: +form.harga, stok: +form.stok },
      ]);
    }
    setShowModal(false);
  };
      ...
      <div className="menu-grid">
        {filtered.length === 0 ? (
          ...
          filtered.map((m) => {
            ...
            const barColor =
              cls === "out" ? "#e74c3c" : cls === "low" ? COLORS.rosyBrown : COLORS.mossGreen;
              ...
              <div key={m.id} className="menu-card">
                ...
                <div className="menu-card-body">
                  ...
                  <div className="stock-row">
                    ...
                    <span className="stock-count" style={{ color: barColor }}>
                      {m.stok}
                    </span>
                  </div>
