...
import { register, login } from "../../services/api"; // aktifkan setelah API jalan
...
const css = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* SUCCESS */
  .success-msg { background: rgba(16,185,129,0.08); border: 1px solid rgba(16,185,129,0.2); color: #059669; font-size: 13px; font-weight: 500; padding: 10px 14px; border-radius: 10px; margin-bottom: 18px; }
...
export default function Register({ onRegisterSuccess, onGoToLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // ── DUMMY REGISTER (hapus setelah API jalan) ───────────────
      await new Promise(r => setTimeout(r, 900));
      // Simulasi berhasil — langsung login dengan data dummy
      onRegisterSuccess({ id: 99, name: form.name, email: form.email, role: "buyer" });
          ...
          <div className="reg-left-content">
            ...
            <div className="reg-steps">
              <div className="reg-step">
                ...
                <div className="reg-step-text">Daftar dengan email dan password</div>
              </div>
              <div className="reg-step">
                <div className="reg-step-num">2</div>
                <div className="reg-step-text">Pilih menu dari berbagai stan</div>
              </div>
              <div className="reg-step">
                <div className="reg-step-num">3</div>
                <div className="reg-step-text">Checkout sekali, bayar selesai!</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="reg-right">
          <div className="reg-right-inner">
              ...
              <div className="form-group">
                ...
                {form.password && (
                  <div className="pass-strength">
                    ...
                    <span className={`pass-label ${strength}`}>
                      {strength === "weak" ? "Lemah" : strength === "medium" ? "Cukup" : "Kuat"}
                    </span>
                  </div>
                )}
            ...
            <div className="reg-footer">
              Sudah punya akun?{" "}
              <a onClick={onGoToLogin}>Masuk di sini</a>
            </div>
          </div>
        </div>
      </div>
