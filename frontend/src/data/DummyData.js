...
// Status pesanan — SATU definisi, dipakai buyer & seller
...
// Alur status yang bisa di-advance oleh seller
...
// Dummy orders — dipakai buyer (OrderStatus & History) DAN seller (Orders & Dashboard)
export const DUMMY_ORDERS = [
  ...
  },
  {
    ...
    stalls: ["Ayam Geprek"],
    items: [
      { id: 4, nama: "Ayam Geprek L5", qty: 1, subtotal: 15000, stall_name: "Ayam Geprek", foto_url: "https://images.unsplash.com/photo-1562967916-eb82221dfb92?w=200&q=80" },
    ],
    timeline: [
      { status: "pending", time: "08:05", label: "Pesanan dibuat" },
    ],
  },
];

// Dummy notifikasi buyer
