                            ...
                            {order.status === "cancelled" ? (
                              <>
                                ...
                                <div className="tl-item">
                                  ...
                                  <div><div className="tl-label">Pesanan dibatalkan</div><div className="tl-time">{fmtDateTime(order.updated_at || order.created_at)}</div></div>
                                </div>
                              </>
                            ) : (
                              TIMELINE_STEPS.filter(s => getStatusStep(s.status) <= currentStep).map((s, i, arr) => (
                                <div className="tl-item" key={s.status}>
                                  ...
                                  <div>
                                    ...
                                    <div className="tl-time">{fmtDateTime(order.updated_at || order.created_at)}</div>
                                  </div>
                                </div>
                              ))
                            )}
